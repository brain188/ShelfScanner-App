...
class TestUserRegistration:
    ...
    def test_register_password_hashing(self, client, user_data):
        ...
        with patch('app.db.supabase.supabase_ops.create_user') as mock_create:
...
class TestUserLogin:
    ...
    def test_login_success(self, client, user_data, mock_user):
        ...
        # Then login
        with patch('app.db.supabase.supabase_ops.get_user_by_email') as mock_get:
...
class TestPasswordReset:
    ...
    def test_reset_password_with_token(self, client):
        ...
        with patch('app.db.supabase.supabase_ops.get_user_by_reset_token') as mock_get, \
             patch('app.db.supabase.supabase_ops.update_user') as mock_update:
...
class TestEmailVerification:
    ...
    def test_send_verification_email(self, client, auth_headers, mock_user):
        ...
        with patch('app.db.supabase.supabase_ops.get_user_by_id') as mock_get, \
             patch('app.services.email_service.send_verification_email') as mock_email:
    ...
    def test_verify_email_success(self, client):
        ...
        with patch('app.db.supabase.supabase_ops.verify_email_token') as mock_verify:
...
class TestAuthenticationFlow:
    ...
    def test_complete_auth_flow(self, client, user_data):
        ...
        # 2. Login
        with patch('app.db.supabase.supabase_ops.get_user_by_email') as mock_get_email:
        ...
        with patch('app.db.supabase.supabase_ops.get_user_by_id') as mock_get_id:
